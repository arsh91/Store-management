                ...
                @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9" style="display: flex;">
                            <input type="password" class="form-control" name="password" id="password" autocomplete="new-password" value="{{ old('passsword') }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="pincode" id="pincode" maxlength="6" value="{{ old('pincode') }}">
                        </div>
                    </div>
                    <div class="card-footer text-center">
                        <a href="{{ route('users.index') }}" class="btn btn-secondary">Back</a>
                        <button type="submit" name="submitstore" class="btn btn-primary">Add User</button>
                    </div>
            </form>
