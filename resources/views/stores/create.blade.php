    ...
    <div class="card" style="width:580px;">
        <div class="card-body">
            <div class="box-header with-border mt-5" id="filter-box">
                ...
                @endif
                <form method="post" id="addStoreForm" action="{{ route('stores.store') }}">
                @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="pincode" id="pincode" autofocus value="{{ old('pincode') }}">
                    ...
                    <div class="card-footer text-center">
                        ...
                        <button type="submit" name="submitstore" class="btn btn-primary">Add Store</button>
                    </div>
            </form>
