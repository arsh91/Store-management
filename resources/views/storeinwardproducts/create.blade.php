@extends('layout')
@section('title', 'Add Store Inward Product')
@section('subtitle', 'Add Store Inward Product')
@section('content')
<style>
.it {
  height: 100px;
    ...
    <div class="card" style="width:742px;">
        <div class="card-body">
            <div class="box-header with-border mt-5" id="filter-box">
                ...
                @endif
                <form method="post" id="addStoreInwardProductForm" action="{{ route('storeinwardproducts.store') }}" enctype="multipart/form-data">
                @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                        <input type="number" class="form-control" name="stock_inward" id="stock_inward" value="{{ old('stock_inward') }}" min="1">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                        <input type="number" class="form-control" name="product_price" id="product_price" value="{{ old('product_price') }}" min="1">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                        <input type="number" class="form-control" name="total_amount" id="total_amount" value="{{ old('total_amount') }}" min="1">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                        <input type="number" class="form-control" name="bill_no" id="bill_no" value="{{ old('bill_no') }}" min="1">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                        <input type="text" class="form-control" name="inward_person_from" id="inward_person_from" value="{{ old('inward_person_from') }}">
                    ...
                    <div class="row mb-3">
                        <label for="bill_image" class="col-sm-3 col-form-label required">Bill Image</label>
                        <div class="col-sm-9">
                    ...
                    <div class="card-footer text-center">
                        ...
                        <button type="submit" name="submitinwardproducts" class="btn btn-primary">Save</button>
                    </div>
            </form>
