...
@section('subtitle', 'Edit Store Product')
@section('content')
<style>
.it {
  height: 100px;
    ...
    <div class="card" style="width:740px;">
        <div class="card-body">
            <div class="box-header with-border mt-5" id="filter-box">
                ...
                @endif
                <form method="post" id="editStoreproductForm" action="{{ route('storeproducts.update', $storeproducts->id) }}" enctype="multipart/form-data">
                @csrf
                    <div class="row mb-3">
                        <label for="product_code" class="col-sm-3 col-form-label required">Product Code</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="product_code" id="product_code" value="{{ old('product_code', $storeproducts->product_code ?? '') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="product_name" id="product_name" value="{{ old('product_name', $storeproducts->product_name ?? '') }}">
                            ...
                            <select class="search_select form-select" style="width: 281.528px;" name="product_category" id="product_category">
                                <option value="">Select Product Category</option>
                                    @foreach($StoreProductCategories as $category)
                                        <option value="{{ $category->id }}" {{ ( $category->id == $storeproducts->product_category_id ) ? 'selected' : '' }}>{{ $category->category_name }}</option>
                                    @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                        <input type="number" class="form-control" name="current_stock" id="current_stock" value="{{ old('current_stock', $storeproducts->current_stock ?? '') }}" min="1">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                        <input type="number" class="form-control" name="min_price" id="min_price" value="{{ old('min_price', $storeproducts->min_price ?? '') }}" min="1">
                        ...
                        <div class="col-sm-4">
                        <input type="number" class="form-control" name="max_price" id="max_price" value="{{ old('max_price', $storeproducts->max_price ?? '') }}" min="1">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                        <textarea name="product_description" rows="3" class="form-control" id="product_description">{{ old('product_description', $storeproducts->product_description ?? '') }}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="img_preview file_preview mt-2">
                                <img id="file_img" src="{{asset('').$storeproducts->product_image}}" class="preview_file it" />
